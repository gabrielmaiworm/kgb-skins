        ...
        <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen} modal={modalPopover}>
          ...
          <PopoverTrigger asChild>
            <Button
              ...
              className={cn(
                "flex p-1 rounded-lg border bg-background min-h-10 h-auto items-center justify-between [&_svg]:pointer-events-auto",
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="ml-2 h-4 mb-1 w-4 cursor-pointer hover:bg-white/20 rounded-sm p-0.5 -m-0.5 focus:outline-none focus:ring-1 focus:ring-white/50"
                            >
            ...
            <Command>
              ...
              <CommandList
                className={cn(
                  ...
                  "overscroll-y-contain scrollbar-thin scrollbar-thumb-rounded-md scrollbar-track-transparent scrollbar-thumb-muted-foreground/30 hover:scrollbar-thumb-muted-foreground/50"
                )}
              >
                  ...
                  <CommandGroup>
                    ...
                    >
                      ...
                      <span>
                        ...
                        {getAllOptions().length > 20 ? ` - ${getAllOptions().length} opções` : ""})
                      </span>
                    </CommandItem>
                  </CommandGroup>
                )}
